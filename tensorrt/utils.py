...
def add_common_args(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Configuration of Draft-Target-Model decoding, see `examples/draft_target_model/README.md` for more information."
    ...
    parser.add_argument(
        ...
        default=0.5,
        type=float,
        help="Specify the kv cache fraction reserved for cross attention. Only applicable for encoder-decoder models. By default 0.5 for self and 0.5 for cross.",
    )
    parser.add_argument(
