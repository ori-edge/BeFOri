...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The path where the model snapshot is saved, e.g. '~/.cache/huggingface/hub/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659/'",
    )
    parser.add_argument(
        "--model_name",
        type=str,
        default=None,
        help="The model name on HuggingFace, e.g. 'meta-llama/Llama-3.1-8B-Instruct'",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="Number of samples for calibration. Set to -1 to use the whole dataset.",
    )
    parser.add_argument(
...
def args_to_quant_config(args: argparse.Namespace) -> QuantConfig:
    ...
    if args.use_weight_only:
        quant_config = precision_to_config(
            args.weight_only_precision, args.group_size, quant_config
        )
    elif args.use_fp8:
        ...
        quant_config.quant_algo = (
            ...
            if args.per_group
            else QuantAlgo.W4A8_QSERVE_PER_CHANNEL
        )
    ...
    if args.model_name is not None:
        ...
        AutoModelForCausalLM.from_pretrained(
            ...
            use_auth_token=os.environ.get(
                "HF_ACCESS_TOKEN"
            ),  # Use correct argument for authentication
